...
// ============================================================
// KHARCHA — Onboarding Wizard (client component)
// 5-step flow: Welcome → Name → PIN Length → PIN Setup → All Set
//
// Extracted from page.tsx so that page.tsx can be a Server
// Component and perform a redirect guard before rendering this.
// ============================================================
...
export default function OnboardingWizard() {
  ...
  const handleComplete = useCallback(async () => {
    ...
    try {
      ...
      // Hard redirect so the browser fetches a fresh Clerk session
      // token that includes onboarding_completed:true in its claims.
      // A soft router.push() might send the stale JWT to middleware
  ...
  }, [userId, displayName, pin, pinLength, setKey]);
