...
const securityHeaders = [
  {
    ...
    value: [
      ...
      `connect-src 'self' https://*.supabase.co https://api.anthropic.com https://api.clerk.com https://clerk-telemetry.com https://api.exchangerate-api.com https://*.clerk.accounts.dev${isDev ? " ws://localhost:* http://localhost:*" : ""}`,
